...
import 'package:exemplos_flutter/mobile/screens/home_page.dart';
import 'package:exemplos_flutter/mobile/screens/user-data/data_collector.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 32),
              ElevatedButton(onPressed: () => context.back(), child: Text('Navigate Back')),
              const SizedBox(height: 32),
              ElevatedButton(
                onPressed: () {
