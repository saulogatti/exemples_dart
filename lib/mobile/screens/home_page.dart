...
import 'package:exemplos_flutter/mobile/router/router.dart';
import 'package:exemplos_flutter/mobile/router/router.gr.dart';
  ...
  Widget buildBottomNav(BuildContext context, TabsRouter tabsRouter) {
    ...
    return hideBottomNav
        ...
        : BottomNavigationBar(
            ...
            items: [
              BottomNavigationBarItem(icon: Icon(Icons.source), label: 'Books'),
              BottomNavigationBarItem(icon: Icon(Icons.person), label: 'Profile'),
              if (_showSettingsTap) BottomNavigationBarItem(icon: Icon(Icons.settings), label: 'Settings'),
            ],
          );
  }
  ...
  Widget build(BuildContext context) {
    return AutoLeadingButton.builder(
      builder: (context, leading) {
        return Scaffold(
          appBar: AppBar(leading: leading, title: Text('Welcome'), centerTitle: false),
          body: Center(
